...
export const metadata: Metadata = {
  ...
  description:
    'Follow sharp money in real time. Delta reads exchange orderbooks, tracks whale bets, and surfaces sharp money signals across NBA, NFL, NHL, and MLB. Start with a 3-day annual trial.',
  alternates: {
