...
import ShareableSharpProjectionCard, {
  type ShareableSharpProjection,
} from './ShareableSharpProjectionCard'
import { useShareImage } from '@/hooks/useShareImage'

type ShareProjectionButtonProps = {
  projection: ShareableSharpProjection
}

export default function ShareProjectionButton({ projection }: ShareProjectionButtonProps) {
  ...
  return (
    <>
      ...
      {showCard && <ShareableSharpProjectionCard ref={cardRef} projection={projection} />}
    </>
  )
}
