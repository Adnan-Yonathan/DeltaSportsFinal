...
import ShareableTradeCard from './ShareableTradeCard'
import type { ShareableTradeCardProps } from './ShareableTradeCard'

interface ShareTradeButtonProps {
  trade: ShareableTradeCardProps['trade']
  matchupLabel?: string
}

export default function ShareTradeButton({ trade, matchupLabel }: ShareTradeButtonProps) {
  ...
  return (
    <>
      ...
      {showCard && (
        <ShareableTradeCard ref={cardRef} trade={trade} matchupLabel={matchupLabel} />
      )}
    </>
  )
}
