  ...
  return (
    ...
    >
      <div className="text-center space-y-2">
        ...
        <p className="text-white/60">This is how you&apos;ll be known on Delta Sports</p>
      </div>
      ...
      <div className="max-w-md mx-auto space-y-4">
        <div className="relative">
          <input
            ...
            className="w-full bg-zinc-900/80 backdrop-blur-sm text-white placeholder:text-white/40 border border-white/10 rounded-xl py-4 px-6 focus:outline-none focus:border-emerald-500 text-lg pr-12"
            maxLength={20}
          />
        ...
        <p className="text-white/40 text-xs">
          3-20 characters ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ Letters, numbers, and underscores only
        </p>
      </div>
    </motion.div>
  )
