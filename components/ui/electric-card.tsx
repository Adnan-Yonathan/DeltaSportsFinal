...
type ElectricCardSize = "default" | "compact"
...
const ElectricCard = ({
  ...
  const sizeClass = size === "compact" ? "ec-compact" : ""

  return (
    <div className={`ec-wrap ${sizeClass} ${className}`}>
      ...
      <style jsx>{`
        ...
        .ec-wrap.ec-compact .content-top,
        .ec-wrap.ec-compact .content-bottom {
          padding: 18px;
        }
        ...
        .ec-wrap.ec-compact .title {
          font-size: 1.05em;
          font-weight: 600;
        }

        .ec-wrap.ec-compact .description {
          font-size: 0.85em;
        }

        .ec-wrap.ec-compact .scrollbar-glass {
          font-size: 0.7em;
          padding: 0.35em 0.7em;
        }

        .ec-wrap.ec-intensity-strong .background-glow {
          filter: blur(36px);
          opacity: 0.45;
          transform: scale(1.12);
        }
        .ec-wrap.ec-intensity-strong .glow-layer-2 {
          filter: blur(6px);
        }
        .ec-wrap.ec-intensity-strong .overlay-1,
        .ec-wrap.ec-intensity-strong .overlay-2 {
          transform: scale(1.12);
        }

        .ec-wrap.ec-intensity-medium .background-glow {
          filter: blur(28px);
          opacity: 0.35;
          transform: scale(1.08);
        }
        .ec-wrap.ec-intensity-medium .glow-layer-2 {
          filter: blur(4px);
        }
        .ec-wrap.ec-intensity-medium .overlay-1,
        .ec-wrap.ec-intensity-medium .overlay-2 {
          transform: scale(1.08);
        }

        .ec-wrap.ec-intensity-low .background-glow {
          filter: blur(20px);
          opacity: 0.25;
          transform: scale(1.04);
        }
        .ec-wrap.ec-intensity-low .glow-layer-2 {
          filter: blur(3px);
        }
        .ec-wrap.ec-intensity-low .overlay-1,
        .ec-wrap.ec-intensity-low .overlay-2 {
          transform: scale(1.04);
        }
      `}</style>
    </div>
