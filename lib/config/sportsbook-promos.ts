...
export const SPORTSBOOK_PROMOS: SportsbookPromo[] = [
  ...
  // ========== THESCORE BET (ESPN BET) ==========
  {
    ...
    title: 'Bet $10, Get $100 in Bonus Bets',
    description:
      'Place a $10 bet; once it settles, receive $100 in bonus bets (typically 5 x $20) win or lose',
    category: PROMO_CATEGORIES.NEW_USER,
    type: PROMO_TYPES.BONUS_BETS,
    value: '$100 bonus bets',
    minBet: 10,
  ...
  // ========== DFS PLATFORMS (HOLIDAY 2025) ==========
  {
    id: 'sleeper-holiday-signup-2025',
    bookmaker: 'sleeper',
    bookmakerDisplayName: 'Sleeper',
    title: 'Holiday Sign-Up Bonus: $20 Free Entry + 100% Match',
    description:
      'New users receive a $20 free entry plus a 100% deposit match up to $100 during Christmas week',
    category: PROMO_CATEGORIES.NEW_USER,
    type: PROMO_TYPES.DEPOSIT_MATCH,
    value: '$20 free entry + 100% match up to $100',
  ...
  {
    id: 'sleeper-daily-free-square',
    bookmaker: 'sleeper',
    bookmakerDisplayName: 'Sleeper',
    title: 'Daily Free 0.5 Stat Pick',
    description:
      'Daily free square pick (0.5 stat line) usable in pick-em entries, including Christmas Day',
    category: PROMO_CATEGORIES.DAILY,
    type: PROMO_TYPES.FREE_BET,
    value: 'Daily free square',
    link: 'https://sleeper.com/',
    createdAt: '2025-12-25T00:00:00Z',
    updatedAt: '2025-12-25T00:00:00Z',
  },
  {
    id: 'underdog-play5-get75-holiday',
    bookmaker: 'underdog',
    bookmakerDisplayName: 'Underdog Fantasy',
    title: 'Play $5, Get $75 Bonus Cash',
    description:
      'Deposit $10+, play a $5 entry, and get $75 in bonus cash after the entry settles (holiday offer)',
    category: PROMO_CATEGORIES.NEW_USER,
    type: PROMO_TYPES.BONUS_BETS,
    value: '$75 bonus cash',
    minDeposit: 10,
    minBet: 5,
    link: 'https://underdogfantasy.com/pickem',
    expiresAt: '2025-12-31T23:59:59Z',
    createdAt: '2025-12-25T00:00:00Z',
    updatedAt: '2025-12-25T00:00:00Z',
  },
  {
    id: 'underdog-unwrapped-2025',
    bookmaker: 'underdog',
    bookmakerDisplayName: 'Underdog Fantasy',
    title: 'Underdog Unwrapped Holiday Promos',
    description:
      'Daily rotating promos through Dec 31 (gimme picks, surprise rewards, boosted payouts)',
    category: PROMO_CATEGORIES.SEASONAL,
    type: PROMO_TYPES.OTHER,
    value: 'Daily promos through 12/31',
    link: 'https://underdogfantasy.com/pickem',
    expiresAt: '2025-12-31T23:59:59Z',
    createdAt: '2025-12-25T00:00:00Z',
    updatedAt: '2025-12-25T00:00:00Z',
  ...
  {
    id: 'prizepicks-play5-get50',
    bookmaker: 'prizepicks',
    bookmakerDisplayName: 'PrizePicks',
    title: 'Play $5, Get $50 Instant Bonus',
    description:
      'New users get $50 in lineup credit after a $5 entry (holiday offer)',
    category: PROMO_CATEGORIES.NEW_USER,
    type: PROMO_TYPES.BONUS_BETS,
    value: '$50 lineup credit',
    minBet: 5,
  ...
  {
    id: 'prizepicks-picksmas-2025',
    bookmaker: 'prizepicks',
    bookmakerDisplayName: 'PrizePicks',
    title: '7 Days of Picksmas',
    description:
      'Daily holiday promos from Dec 20-26 (discounts, payout boosts, protected plays, bonus lineups)',
    category: PROMO_CATEGORIES.SEASONAL,
    type: PROMO_TYPES.OTHER,
    value: 'Daily promos (Dec 20-26)',
    link: 'https://www.prizepicks.com/',
  ...
  {
    id: 'draftkings-pick6-play5-get50',
    bookmaker: 'draftkings-pick6',
    bookmakerDisplayName: 'DraftKings Pick6',
    title: 'Play $5, Get $50 in Pick6 Credits',
    description:
      'New users who play $5+ receive $50 in Pick6 credits for future entries',
    category: PROMO_CATEGORIES.NEW_USER,
    type: PROMO_TYPES.BONUS_BETS,
    value: '$50 Pick6 credits',
    minBet: 5,
  ...
  {
    id: 'draftkings-pick6-winter-wonderland-2025',
    bookmaker: 'draftkings-pick6',
    bookmakerDisplayName: 'DraftKings Pick6',
    title: 'WIN-ter Wonderland Daily Promos',
    description:
      'Holiday daily rotation with gimme picks and winnings boosts through late December',
    category: PROMO_CATEGORIES.SEASONAL,
    type: PROMO_TYPES.OTHER,
    value: 'Daily promos through 12/31',
    link: 'https://pick6.draftkings.com/',
  ...
  // ========== SPORTSBOOK HOLIDAY PROMOS (2025) ==========
  {
    id: 'draftkings-holiday-profit-boosts-2025',
    bookmaker: 'draftkings',
    bookmakerDisplayName: 'DraftKings',
    title: 'Daily Holiday Profit Boosts',
    description:
      'Holiday-week profit boost tokens usable on any sport with same-day expiration',
    category: PROMO_CATEGORIES.DAILY,
    type: PROMO_TYPES.PROFIT_BOOST,
    value: 'Holiday profit boosts',
    link: 'https://sportsbook.draftkings.com/promos',
    expiresAt: '2025-12-31T23:59:59Z',
    createdAt: '2025-12-25T00:00:00Z',
    updatedAt: '2025-12-25T00:00:00Z',
  ...
  {
    id: 'draftkings-holiday-sgp-boost-2025',
    bookmaker: 'draftkings',
    bookmakerDisplayName: 'DraftKings',
    title: '30% NFL/NBA Same-Game Parlay Boost',
    description:
      'Holiday-week profit boost token for NFL or NBA same-game parlays',
    category: PROMO_CATEGORIES.SEASONAL,
    type: PROMO_TYPES.PROFIT_BOOST,
    value: '30% profit boost',
    link: 'https://sportsbook.draftkings.com/promos',
  ...
  {
    id: 'fanduel-pass-the-leg-2025',
    bookmaker: 'fanduel',
    bookmakerDisplayName: 'FanDuel',
    title: 'Pass The Leg Group Parlay Boost',
    description:
      'Group parlay builder for NFL Christmas games with a holiday profit boost',
    category: PROMO_CATEGORIES.SEASONAL,
    type: PROMO_TYPES.PROFIT_BOOST,
    sport: PROMO_SPORTS.NFL,
    value: 'Group parlay boost',
    link: 'https://sportsbook.fanduel.com/promotions',
    expiresAt: '2025-12-25T23:59:59Z',
    createdAt: '2025-12-25T00:00:00Z',
    updatedAt: '2025-12-25T00:00:00Z',
  ...
  {
    id: 'betmgm-football-frenzy-2025',
    bookmaker: 'betmgm',
    bookmakerDisplayName: 'BetMGM',
    title: 'Football Frenzy Leaderboard',
    description:
      'Holiday leaderboard contest awarding bonus bets for winning football bets at longer odds',
    category: PROMO_CATEGORIES.SEASONAL,
    type: PROMO_TYPES.OTHER,
    sport: PROMO_SPORTS.NFL,
    value: '$100,000 bonus bet pool',
    link: 'https://sports.betmgm.com/en/promotions',
  ...
  {
    id: 'betmgm-christmas-boosts-2025',
    bookmaker: 'betmgm',
    bookmakerDisplayName: 'BetMGM',
    title: 'Christmas Day Boosts and Tokens',
    description:
      'Holiday tokens for odds boosts, SGP boosts, and no-sweat bet insurance on Christmas games',
    category: PROMO_CATEGORIES.SEASONAL,
    type: PROMO_TYPES.PROFIT_BOOST,
    value: 'Boosts and no-sweat tokens',
    link: 'https://sports.betmgm.com/en/promotions',
    expiresAt: '2025-12-25T23:59:59Z',
    createdAt: '2025-12-25T00:00:00Z',
    updatedAt: '2025-12-25T00:00:00Z',
  ...
  {
    id: 'caesars-parlays-for-presents-2025',
    bookmaker: 'caesars',
    bookmakerDisplayName: 'Caesars Sportsbook',
    title: 'Parlays for Presents (NJ)',
    description:
      'Place a qualifying parlay and redeem a holiday gift in Atlantic City during Dec 22-25',
    category: PROMO_CATEGORIES.SEASONAL,
    type: PROMO_TYPES.OTHER,
    value: 'Holiday gift redemption',
    link: 'https://www.caesars.com/sportsbook-and-casino/promotions',
    states: ['NJ'],
    expiresAt: '2025-12-25T23:59:59Z',
    createdAt: '2025-12-25T00:00:00Z',
  ...
  {
    id: 'betrivers-12-days-parlays-2025',
    bookmaker: 'betrivers',
    bookmakerDisplayName: 'BetRivers',
    title: '12 Days of Parlays',
    description:
      'Daily parlay-focused promos from Dec 22 through Jan 2 (boosts, insurance, specials)',
    category: PROMO_CATEGORIES.SEASONAL,
    type: PROMO_TYPES.OTHER,
    value: 'Daily parlay promos',
    link: 'https://www.betrivers.com/promotions',
  ...
  {
    id: 'fanatics-second-chance-1000',
    bookmaker: 'fanatics',
    bookmakerDisplayName: 'Fanatics Sportsbook',
    title: 'Up to $1,000 in Second-Chance Bets',
    description:
      'First bet each day for 10 days is insured up to $100; losing bets are refunded as bonus bets',
    category: PROMO_CATEGORIES.NEW_USER,
    type: PROMO_TYPES.RISK_FREE_BET,
    value: 'Up to $1,000',
    link: 'https://sportsbook.fanatics.com/promotions',
