...
export const TEAMS_REGISTRY: TeamRecord[] = [
  {
    "id": "1",
    "name": "Atlanta Hawks",
    "shortName": "Hawks",
  ...
  {
    "id": "15",
    "name": "Anna Maria College Amcats",
  ...
  {
    "id": "17",
    "name": "Claremont-Mudd-Scripps College Stags/Athenas",
  ...
  {
    "id": "33",
    "name": "Colby College White Mules",
    "shortName": "Colby",
    "abbreviation": "COLBY",
    "sport": "americanfootball_ncaaf",
    "aliases": [
...
// Helper functions for accessing the registry
