const ESPN_SITE_BASE = 'https://site.api.espn.com/apis/site/v2/sports/hockey/nhl'
const ESPN_CORE_BASE = 'https://sports.core.api.espn.com/v2/sports/icehockey/leagues/nhl'
const ESPN_WEB_BASE = 'https://site.web.api.espn.com/apis/common/v3/sports/hockey/nhl'
